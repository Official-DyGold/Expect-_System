...
timeofuse = Label(adminframeheader, text='Guest Section', font=('Microsoft Yahei Ui Light', 20), fg='white',
                  bg='darkblue')
...
errorlabel = Label(manageuserframe, text="", fg='darkblue', bg='white', font=("Microsoft Yahei Ui Light", 8))
...
faultsolution.config(state='disabled')
userchat.config(state='disabled')
adminhome.config(state='disabled')
manageuser.config(state='disabled')
